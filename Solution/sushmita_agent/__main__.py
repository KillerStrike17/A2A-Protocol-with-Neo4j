...
def main():
    ...
    try:
        ...
        agent_card = AgentCard(
            name="Sushmita Agent",
            description=(
                "A friendly agent that helps with scheduling availability and provides "
                "information about Sushmita's movie preferences, including favorite genres "
                "and movies already watched."
            ),
            url=agent_host_url,
            version="1.0.0",
